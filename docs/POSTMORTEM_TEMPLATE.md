...
_What did this incident teach us? What assumptions were wrong?_

## Action Items

| Action | Owner | Due Date |
|--------|-------|----------|
| _e.g., Add pre-apply validation check_ | @username | YYYY-MM-DD |
| _e.g., Add monitoring alert for resource deletion_ | @username | YYYY-MM-DD |
